 ...
 */
public class DisplayProductInfoWithCompletionService2 {
    ...
    public DisplayProductInfoWithCompletionService2(ExecutorService executorService) {
    ...
    public static void main(String[] args) {
        DisplayProductInfoWithCompletionService2 cd = new DisplayProductInfoWithCompletionService2(Executors.newCachedThreadPool());
